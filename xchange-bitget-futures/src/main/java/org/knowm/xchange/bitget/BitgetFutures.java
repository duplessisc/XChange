...
public interface BitgetFutures {
  ...
  BitgetResponse<List<BitgetContractDto>> contracts(@QueryParam("symbol") String symbol, @QueryParam("productType") String productType)
      throws IOException, BitgetException;

  @GET
  @Path("api/v2/mix/market/tickers")
  BitgetResponse<List<BitgetFuturesTickerDto>> allTickers(@QueryParam("productType") String productType)
      throws IOException, BitgetException;

  @GET
  @Path("api/v2/mix/market/ticker")
  BitgetResponse<List<BitgetFuturesTickerDto>> ticker(@QueryParam("symbol") String symbol, @QueryParam("productType") String productType)
      throws IOException, BitgetException;
