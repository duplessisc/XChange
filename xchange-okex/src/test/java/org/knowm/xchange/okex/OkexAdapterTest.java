...
public class OkexAdapterTest {
  ...
  public void testAdaptTradingFee() throws IOException {
    ...
    OkexTradeFee okexSpotTradeFee = mapper.readValue(is, new TypeReference<OkexResponse<List<OkexTradeFee>>>() {}).getData().get(0);
    ...
    OkexTradeFee okexSwapTradeFee= mapper.readValue(is, new TypeReference<OkexResponse<List<OkexTradeFee>>>() {}).getData().get(0);
    assertThat(OkexAdapters.adaptTradingFee(okexSwapTradeFee,SWAP, new FuturesContract("BTC/USDT/SWAP")))
        .isEqualTo(new Fee(new BigDecimal("0.0002"),new BigDecimal("0.0005")));
    assertThat(OkexAdapters.adaptTradingFee(okexSwapTradeFee,SWAP, new FuturesContract("BTC/USDT/SWAP")))
        .isEqualTo(new Fee(new BigDecimal("0.0002"),new BigDecimal("0.0005")));
    assertThat(OkexAdapters.adaptTradingFee(okexSwapTradeFee,SWAP, new FuturesContract("USDC/USDT/SWAP")))
        .isEqualTo(new Fee(new BigDecimal("0.0002"),new BigDecimal("0.0005")));
    // currently no USD support in OKX swap
//    assertThat(OkexAdapters.adaptTradingFee(okexSwapTradeFee,SWAP, new FuturesContract("BTC/USD/SWAP")))
//        .isEqualTo(new Fee(new BigDecimal("-0.0002"),new BigDecimal("-0.0005")));
  }
